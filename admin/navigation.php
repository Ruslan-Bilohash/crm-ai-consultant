        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-10 text-sm">
                ...
                <a href="conversations.php" 
                   class="flex items-center gap-2 text-zinc-300 hover:text-white transition-colors <?= basename($_SERVER['PHP_SELF']) === 'conversations.php' ? 'text-white font-medium' : '' ?>">
...
?>
<div class="hidden sm:flex items-center gap-2 text-xs font-mono text-emerald-400 bg-zinc-950 px-3 py-1.5 rounded-xl border border-emerald-900/50">
    v<?= CRM_AI_VERSION ?>
</div>
